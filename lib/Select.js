...
var Select = _react2['default'].createClass({
	...
	handleInputBlur: function handleInputBlur(event) {
		...
		if (this.refs.menu && (this.refs.menu === document.activeElement || this.refs.menu.contains(document.activeElement) || document.activeElement === this.refs.menu.parentNode)) {
			this.focus();
			return;
		}
